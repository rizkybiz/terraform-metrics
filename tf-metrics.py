...
parser = argparse.ArgumentParser(
    description="Get the total number of runs of all Terraform Workspaces in the provider Organization"
)
parser.add_argument("-t", "--token", help="TFE/TFC User Token", required=True)
parser.add_argument(
    "-o", "--organization", help="TFE/TFC Organization to target", required=True
)
parser.add_argument(
    "-u", "--url", help="URL of TFE instance without scheme (https://). Defaults to TFC"
)
